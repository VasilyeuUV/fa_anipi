...
import 'package:fa_anipi/modules/anime_module/dio_retrofit/dio/aniapi_web_service.dart';
import 'package:fa_anipi/modules/anime_module/dio_retrofit/retrofit/aniapi_r_model.dart';
import 'package:flutter/foundation.dart';

class AnimeProvider {
  Future<AniApiRModel?> getAnime([
    String? title,
    int? aniListId,
    int? myAniListId,
    List<int>? formatShow,
    ...
    AniApiWebService aniService = AniApiWebService(dio.Dio());
    final result = await aniService.getAnime(_parameters);
